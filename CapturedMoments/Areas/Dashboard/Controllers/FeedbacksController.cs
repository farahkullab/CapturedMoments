...
namespace CapturedMoments.Areas.Dashboard.Controllers
{
    ...
    public class FeedbacksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FeedbackId,PhotographerName,FeedbackText,ClientName,IsActive,IsDeleted,CreationDate")] Feedback feedback)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FeedbackId,PhotographerName,FeedbackText,ClientName,IsActive,IsDeleted,CreationDate")] Feedback feedback)
        {
